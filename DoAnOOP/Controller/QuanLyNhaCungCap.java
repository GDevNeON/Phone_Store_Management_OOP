...
public class QuanLyNhaCungCap extends NhaCungCap implements ControllerInterface {
    ...
    public void Create() {
        ...
        } while (!isValidPhoneNumber(getSDT()));

        System.out.println("Nhập số fax nhà cung cấp");
        setFax(input.nextLine());

        try {
            String input = getMaNCC() + ";" + getTenNCC() + ";" + getDiaChi() + ";" + getSDT() + ";"
                    + getFax();
                    ...
                    if (DSNCC[i].getMaNCC().equals(maNCC)) {
                        ...
                        switch (index) {
                            ...
                            case 4:
                                ...
                                DSNCC[i].setSDT(getSDT());
                                break;
                            case 5:
                                System.out.println("Nhập số fax nhà cung cấp");
                                input.nextLine();
                                setFax(input.nextLine());
                                DSNCC[i].setFax(getFax());
                                break;
                        }
                    }
